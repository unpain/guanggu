...
module.exports = () => {
  ...
  fs.writeFile('./src/data/data.json', JSON.stringify(
    {
  ...
  return { user: user, admin: admin, trafficDepartment: trafficDepartment, event: Object.values(event).flat(), notice: Object.values(notice).flat() };
};
